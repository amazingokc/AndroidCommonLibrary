package com.runde.commonlibrary.net.deprecated_net.interceptors.interceptors.logging;
...
public class Printer {
    ...
    public static void printJsonResponse(LoggingInterceptor.Builder builder, long chainMs, boolean isSuccessful,
    ...
    public static void printFileResponse(LoggingInterceptor.Builder builder, long chainMs, boolean isSuccessful,
