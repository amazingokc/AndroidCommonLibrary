...
import com.runde.commonlibrary.base.BaseActivity;
...
public class StatusBarUtil {
    ...
    public static void setTranslucentStatus(StatuesBarBaseActivity activity, boolean isDark) {
    ...
    public static boolean isStatusBarVisible(BaseActivity baseActivity) {
        if ((baseActivity.getWindow().getAttributes().flags & WindowManager.LayoutParams.FLAG_FULLSCREEN) == 0) {
            LLog.d("videoLayoutParamsas", "status bar is visible");
            return true;
        } else {
            LLog.d("videoLayoutParamsas", "status bar is not visible");
            return false;
        }
    }
